...
class simple_html_dom {
    ...
    protected function read_tag() {
        ...
        //如果是 doctype, cdata & comments 这类的标签
	...
	/**
	 *  起始到输入字符串一个或者多一个相匹配之前的部分，尽可能多的按顺序过滤输入字符
	 *  @param	string	$chars	想要过滤的字符串
	 */
...
$html = str_get_html('<div id="hello">He<llo</div><div id="world">World</div>');
echo "asdfa\n";
die;
echo $html->find('div', 1)->class  . "\n";
die('end');
$rs = $html->find('body');
var_dump($rs);
?>
